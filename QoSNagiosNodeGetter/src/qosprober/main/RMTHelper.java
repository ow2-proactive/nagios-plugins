...
import qosprober.main.RMMonitorEventReceiver;
import qosprober.main.RMMonitorsHandler;
...
public class RMTHelper {
    ...
    protected static URL startForkedRMApplication = RMTHelper.class
            .getResource("/resources/StartForkedRMApplication.xml");
    ...
    public static URL defaultDescriptor = RMTHelper.class
            .getResource("/resources/GCMNodeSourceDeployment.xml");
    ...
    private static URL functionalTestRMProperties = RMTHelper.class
            .getResource("/resources/functionalTRMProperties.ini");
